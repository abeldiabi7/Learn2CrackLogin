...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btngoToSpam = (Button) findViewById(R.id.button_goToSpam);;
        ...
        **/
        ...
        btngoToSpam.setOnClickListener(new View.OnClickListener() {

            public void onClick(View arg0) {

                Intent spam = new Intent(getApplicationContext(), Spam.class);
                startActivity(spam);
                finish();//a che serve??
            }
        });
